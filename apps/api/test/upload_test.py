...
def main():
    ...
    project_id = create_project("test-sync-docker")
    print(f"Project ID: {project_id}")
    
    print("Uploading audio...")
    upload_audio(project_id, "/app/test/Bryan Adams - (Everything I Do) I Do It For You (Classic Version).mp4")
    
    print("Uploading lyrics...")
    upload_lyrics(project_id, "/app/test/sample_lyrics.txt")
